...
import type { ArchitectureGalleryImage, ArchitectureItem } from 'src/types/architecture';
...
const ArchitectureImageCarousel = ({ data }: ActivityImageCarouselProps) => {
  const theme = useTheme();

  const slides: ArchitectureGalleryImage[] = Array.isArray(data.images)
    ? data.images
    : data.images
...
export default ArchitectureImageCarousel;
