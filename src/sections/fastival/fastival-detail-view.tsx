...
import { useGetFastivalById } from 'src/queries/fastival';
...
const FastivalDetailsView = () => {
  const params = useParams();
  const id = params?.id as string;

  const theme = useTheme();

  const { data } = useGetFastivalById(id);
...
export default FastivalDetailsView;
